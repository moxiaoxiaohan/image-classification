...
def net(input, class_dim=1000):
        ...
        conv = conv_bn_layer(input=input,num_filters=64,filter_size=7,padding=3,stride=2,act='swish',
                    name="res_conv1") 
        '''
        conv = conv_bn_layer(input=input,num_filters=64,filter_size=3,padding=1,stride=2,act='swish',
                    name="res_conv1")
        conv = conv_bn_layer(input=conv,num_filters=64,filter_size=3,padding=1,stride=1,act='swish',
                    name="res_conv1_1")
        conv = conv_bn_layer(input=conv,num_filters=64,filter_size=3,padding=1,stride=1,act='swish',
                    name="res_conv1_2")
        ...
        drop = fluid.layers.dropout(x=pool, dropout_prob=0.75)

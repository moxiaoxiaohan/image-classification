...
def bottleneck_block( input, num_filters, stride, cardinality, name):
        ...
        conv2 = conv_bn_layer(input=conv3,
        ...
        return fluid.layers.elementwise_add(
            ...
            x=short, y=conv2, act='swish', name=name + ".add.output.5")
def net(input, class_dim=1000):
        ...
        '''
        conv1 = conv_bn_layer(input=input,num_filters=64,filter_size=3,padding=1,stride=2,act='swish',
                    name="res_conv1")
        conv2 = conv_bn_layer(input=conv1,num_filters=64,filter_size=3,padding=1,stride=1,act='swish',
                    name="res_conv1_1")
        conv = conv_bn_layer(input=conv2,num_filters=64,filter_size=3,padding=1,stride=1,act='swish',
                    name="res_conv1_2")
        #'''
